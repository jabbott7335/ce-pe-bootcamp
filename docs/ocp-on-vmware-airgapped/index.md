...
The OCP Gymnasium is not air-gapped after provisioning, you need to configure the pfsense firewall/router to simulate the air-gapped environment, after the content has been been mirrored.
