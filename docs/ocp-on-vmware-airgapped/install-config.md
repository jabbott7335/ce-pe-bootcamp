...
2. Enabling vCenter CA Certificate Trust TODO
...
4. Complete the installer survey.
...
5. Review / compare the parameters with the `openshift-install.yaml` template below.
...
6. Modify your Install Config asset.
